import subprocess
from old_pipeline_definitions.blink_remap_search_main_ids_create_script import (
    main as blink_remap_search_main_ids_create_script,
)
import argparse
...
def main():
    ...
    # Generate blink_remap_search_main_ids script
    blink_remap_search_main_ids_script_filepath = (
        blink_remap_search_main_ids_create_script()
    )
    if not blink_remap_search_main_ids_script_filepath:
        exit()
    ...
    com_list = get_components_from_script(blink_remap_search_main_ids_script_filepath)
